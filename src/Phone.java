public class Phone {
	...
	public boolean dominates(Phone other) {
		...
		return ((this.screenSize > other.screenSize && this.batteryCapacity >= other.batteryCapacity) || (this.screenSize >= other.screenSize && this.batteryCapacity > other.batteryCapacity));
	}
}
